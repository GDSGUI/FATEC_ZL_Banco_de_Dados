...
--Consultar Nome, Endereço concatenado, Telefone e Nome do 
--Plano de Saúde de todos os pacientes
...
--Consultar Quantos Planos de Saúde que não 
--tem médicos cadastrados
